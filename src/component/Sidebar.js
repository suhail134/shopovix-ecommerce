...
useEffect(() => {
  ...
  return (
  <div ref={ref}
  className={`fixed right-0 top-0 h-screen sm:w-[60vw] md:w-[40vw] lg:w-[30vw]  w-[95vw] rounded-2xl bg-white/80 backdrop-blur-xl shadow-2xl z-50 transform transition-transform duration-500 ease-in-out ${
